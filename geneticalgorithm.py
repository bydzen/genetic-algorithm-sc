...
PopulationSize = 500 #ukuran populasi
DataSize = 0
NumberOfGenerations = 10 #Loncatan Generasi
MutationRate = 10 #laju crossover
MutationChange = 1 #laju mutasi
Stock_name = 'AAPL' #set the firm ticker that we want to anaylse(use RACE for ferrari and TSLA for tesla adn AAPL for APPLE) 
NumReturn = 10 # mengambil dari 10 hari terakhir
NumberOfDay = 50 #Prediksi untuk 50 hari kedepan
    ...
    def fitnessFunction(self):
        for i in range(len(self.population)):
            ...
            for j in range(DataSize):
                ...
                #We have not found any matches = 0
                if match == False:
...
#Test
print (get_historical_data('AAPL', 100))
